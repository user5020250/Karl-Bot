...
CATEGORIES = {
    ...
    "Messages": [
        ...
        ("/purge bots", "Deletes messages sent by bots.", "Manage Messages"),
        ("/purge links", "Deletes messages containing links.", "Manage Messages"),
        ("/purge invites", "Deletes Discord invite messages.", "Manage Messages"),
        ("/purge images", "Deletes messages with image attachments.", "Manage Messages"),
        ("/purge embeds", "Deletes messages containing embeds.", "Manage Messages"),
        ...
        ("/purge contains", "Deletes messages containing specific text.", "Manage Messages"),
    ...
    "Messaging Tools": [
        ("/say send", "Sends a message as the bot.", "Manage Messages"),
        ("/say edit", "Edits a message previously sent by the bot.", "Manage Messages"),
        ("/embed send", "Sends a custom embed.", "Manage Messages"),
